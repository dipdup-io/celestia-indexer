...
func (m *MockINamespace) CountMessagesByHeight(ctx context.Context, height types0.Level) (int, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *INamespaceCountMessagesByHeightCall) Do(f func(context.Context, types0.Level) (int, error)) *INamespaceCountMessagesByHeightCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *INamespaceCountMessagesByHeightCall) DoAndReturn(f func(context.Context, types0.Level) (int, error)) *INamespaceCountMessagesByHeightCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockINamespace) Messages(ctx context.Context, id uint64, msgType *types.MsgType, limit, offset int) ([]storage.NamespaceMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Messages", ctx, id, msgType, limit, offset)
...
func (mr *MockINamespaceMockRecorder) Messages(ctx, id, msgType, limit, offset any) *INamespaceMessagesCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Messages", reflect.TypeOf((*MockINamespace)(nil).Messages), ctx, id, msgType, limit, offset)
...
// Do rewrite *gomock.Call.Do
func (c *INamespaceMessagesCall) Do(f func(context.Context, uint64, *types.MsgType, int, int) ([]storage.NamespaceMessage, error)) *INamespaceMessagesCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *INamespaceMessagesCall) DoAndReturn(f func(context.Context, uint64, *types.MsgType, int, int) ([]storage.NamespaceMessage, error)) *INamespaceMessagesCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// MessagesByHeight mocks base method.
func (m *MockINamespace) MessagesByHeight(ctx context.Context, height types0.Level, limit, offset int) ([]storage.NamespaceMessage, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *INamespaceMessagesByHeightCall) Do(f func(context.Context, types0.Level, int, int) ([]storage.NamespaceMessage, error)) *INamespaceMessagesByHeightCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *INamespaceMessagesByHeightCall) DoAndReturn(f func(context.Context, types0.Level, int, int) ([]storage.NamespaceMessage, error)) *INamespaceMessagesByHeightCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
