...
type EventAttribute struct {
	Key   bytes.HexBytes `json:"key,omitempty"   protobuf:"bytes,1,opt,name=key,proto3"`
	Value bytes.HexBytes `json:"value,omitempty" protobuf:"bytes,2,opt,name=value,proto3"`
